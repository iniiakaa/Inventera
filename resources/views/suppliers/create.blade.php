<x-layouts.admin active="inventory" title="Tambah Supplier - Inventera">
 ...
 <h2 class="font-display text-display text-on-surface">Tambah Supplier</h2>
 </header>
 ...
 <input type="text" id="npwp" name="npwp" value="{{ old('npwp') }}" placeholder="Opsional"
 class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary focus:border-primary transition-all font-body-md bg-gray-50/50">
 </div>
 ...
 class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary focus:border-primary transition-all font-body-md bg-gray-50/50">{{ old('address') }}</textarea>
 </div>
 ...
 <button type="submit" class="px-6 py-2.5 bg-primary text-on-primary rounded-full font-label-md shadow-md hover:bg-opacity-90 transition-all">Simpan Supplier</button>
 </div>
 </form>
 </section>
</x-layouts.admin>
