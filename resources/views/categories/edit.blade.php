<x-layouts.admin active="categories" title="Edit Kategori - Inventera">
 ...
 <h2 class="font-display text-display text-on-surface">Edit Kategori</h2>
 </header>
 ...
 class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary focus:border-primary transition-all font-body-md bg-gray-50/50">{{ old('description', $category->description) }}</textarea>
 </div>
