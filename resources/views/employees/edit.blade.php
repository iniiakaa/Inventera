        ...
        <form action="{{ route('employees.update', $employee->id) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <select name="role" id="role" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 bg-white focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all font-body-md capitalize" required>
                ...
                <div>
                    ...
                    <select name="branch_id" id="branch_id" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 bg-white focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all font-body-md">
                ...
                <div>
                    ...
                    <select name="is_active" id="is_active" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 bg-white focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all font-body-md" required>
