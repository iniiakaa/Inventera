<x-layouts.admin active="products" title="Tambah Produk - Inventera">
 ...
 <h2 class="font-display text-display text-on-surface">Tambah Produk Baru</h2>
 </header>
 ...
 class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary focus:border-primary font-body-md bg-gray-50/50">{{ old('description') }}</textarea>
 </div>
 </div>
 ...
 <input type="number" id="cost_price" name="cost_price" value="{{ old('cost_price', 0) }}" required min="0" 
 ...
 <div class="grid grid-cols-2 gap-4">
 <div class="space-y-2">
 <label for="sku" class="block font-label-md text-gray-700">SKU</label>
 <input type="text" id="sku" name="sku" value="{{ old('sku') }}" placeholder="Auto Generate jika kosong"
 ...
 <input type="text" id="barcode" name="barcode" value="{{ old('barcode') }}" placeholder="Scan atau Ketik Barcode"
 class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary focus:border-primary font-body-md bg-gray-50/50">
 </div>
 </div>
 </div>
 ...
 <button type="submit" class="px-6 py-2.5 bg-primary text-on-primary rounded-full font-label-md shadow-md hover:bg-opacity-90 transition-all">Simpan Produk</button>
 </div>
 </form>
 </section>
</x-layouts.admin>
