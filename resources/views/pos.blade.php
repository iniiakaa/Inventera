                    ...
                    <div class="bg-black/10 backdrop-blur-[11px] p-8 pb-6">
                        ...
                        <div class="grid grid-cols-3 gap-3 mb-6">
                            <button @click="paymentMethod = 'cash'"
                                :class="paymentMethod === 'cash' ? 'bg-primary/5 border-primary ring-1 ring-primary shadow-sm' : 'bg-white/40 border-white/50 hover:bg-primary/5 hover:border-primary/50 hover:ring-1 hover:ring-primary/30'"
                            ...
                            <button @click="paymentMethod = 'qris'; amountPaid = total"
                                :class="paymentMethod === 'qris' ? 'bg-primary/5 border-primary ring-1 ring-primary shadow-sm' : 'bg-white/40 border-white/50 hover:bg-primary/5 hover:border-primary/50 hover:ring-1 hover:ring-primary/30'"
                                class="group flex flex-col items-center justify-center py-4 rounded-2xl border transition-all">
                            ...
                            <button @click="paymentMethod = 'card'; amountPaid = total"
                                :class="paymentMethod === 'card' ? 'bg-primary/5 border-primary ring-1 ring-primary shadow-sm' : 'bg-white/40 border-white/50 hover:bg-primary/5 hover:border-primary/50 hover:ring-1 hover:ring-primary/30'"
                                class="group flex flex-col items-center justify-center py-4 rounded-2xl border transition-all">
                        ...
                        <div x-show="paymentMethod === 'cash'" x-transition class="mb-2">
                            ...
                            <div class="relative mb-3 group">
                                ...
                                <input type="number" x-model.number="amountPaid"
                                    class="w-full bg-white/50 hover:bg-primary/5 border border-white/60 hover:border-primary/50 rounded-full py-3 pl-14 pr-5 text-on-surface text-lg font-bold focus:outline-none focus:ring-2 focus:ring-primary/40 focus:bg-primary/5 transition-all">
                            </div>
                            <div class="grid grid-cols-3 gap-2">
                                <button @click="amountPaid = total" class="bg-white/50 hover:bg-primary/10 hover:text-primary rounded-full py-2 font-label-sm text-label-sm text-on-surface transition-colors font-medium border border-transparent hover:border-primary/20">Pas</button>
                                <button @click="amountPaid = Math.ceil(total / 50000) * 50000" class="bg-white/50 hover:bg-primary/10 hover:text-primary rounded-full py-2 font-label-sm text-label-sm text-on-surface transition-colors font-medium border border-transparent hover:border-primary/20" x-text="formatRupiah(Math.ceil(total / 50000) * 50000)"></button>
